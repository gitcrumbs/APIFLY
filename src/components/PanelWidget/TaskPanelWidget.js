      ...
      >
        <div>
          <div id="helper_panel" className="panel_expanded rotate">
            <div
              className="task_icons line"
              onClick={togglecollapseexpand}
              onDoubleClick={togglecollapseexpand}
              id="taskbar_icon"
            ></div>

            <div
              className="task_icons_setup line"
              onClick={animateIconOnClick}
              id="taskbar_icon_edit"
            ></div>
            <div
              className="task_icons_setup line"
              onClick={animateIconOnClick}
              id="taskbar_icon_settings"
            ></div>
            <div
              className="task_icons_setup line"
              onClick={animateIconOnClick}
              id="taskbar_icon_Launch"
            ></div>
            <div
              className="task_icons_setup line"
              onClick={animateIconOnClick}
              id="taskbar_icon_search"
            ></div>
            <div
              className="task_icons_setup line"
              onClick={animateIconOnClick}
              id="taskbar_icon_folders"
            ></div>
            <div
              className="task_icons_setup line"
              onClick={animateIconOnClick}
              id="taskbar_icon_links"
            ></div>
            <div
              className="task_icons_setup line"
              onClick={animateIconOnClick}
              id="taskbar_icon_delete"
            ></div>
